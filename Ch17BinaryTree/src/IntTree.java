...
public class IntTree {
    ...
    //return count of number of empty branches 
    //need to count left and count right and total
    //empty tree = 1
    //node with just one branch = 1
    public int countEmpty() 
    {
    	//counts the Empty Nodes in the overallRoot being overridden in the other method
    ...
    public int countEmpty(IntTreeNode root) 
    {
    	if(root == null) 
		{
			//then there is just one empty node
    		return 1;
    	} 
		else
		{ 
    		//count the empty nodes on the left side and right side and add together
